...
import { toPng } from 'html-to-image' // 👈 [핵심] 최신 도구로 교체됨!
  ...
  // ✍️ [수정] 파일 이름에서 한글 제거 (영어+숫자만 사용)
    const saveSignature = async () => {
      ...
      try {
          ...
          // 5. 업로드 (한글 이름 제거: contract_12_admin_12345.pdf 형식)
          const pdfBlob = pdf.output('blob')
          // 👇 [핵심 변경] investor_name을 빼고 안전한 영어 이름으로 저장합니다.
