                ...
                <form onSubmit={handleAuth} className="space-y-5 animate-fade-in-up">
                    ...
                    <button type="submit" disabled={loading || (isMailSent && !isVerified)}
                        ...
                        ${!isMailSent
                            ...
                            : isVerified
                                ? 'bg-indigo-600 hover:bg-indigo-700 text-white shadow-indigo-200 animate-pulse !cursor-pointer'  // 👈 !cursor-pointer 확인
