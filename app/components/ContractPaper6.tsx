...
export default function ContractPaper({ data, car, signatureUrl }: { data: any, car: any, signatureUrl?: string }) {
  ...
  return (
    // 👇 [수정 포인트] Tailwind 색상(bg-white 등) 대신 style={{ backgroundColor: '#ffffff' }} 처럼 직접 지정
    <div
      className="mx-auto shadow-xl print:shadow-none print:w-full text-sm leading-relaxed relative"
      id="printable-area"
      style={{
        backgroundColor: '#ffffff', // bg-white 대신 사용
        color: '#000000',           // text-black 대신 사용
        paddingTop: '10mm', paddingBottom: '10mm', paddingLeft: '15mm', paddingRight: '15mm',
        width: '210mm', minHeight: '297mm'
      }}
    >
      <h1 className="text-2xl font-black text-center mb-6 pb-2" style={{ borderBottom: '2px solid #000000' }}>
        차량 운영 투자 및 수익 배분 계약서
      </h1>

      {/* 갑/을 정보 */}
      <div className="mb-4 grid grid-cols-2 gap-6 text-xs">
        <div>
           <h3 className="font-bold mb-1" style={{ borderBottom: '1px solid #000000' }}>투자자 (이하 '을')</h3>
        ...
        <div>
           <h3 className="font-bold mb-1" style={{ borderBottom: '1px solid #000000' }}>운용사 (이하 '갑')</h3>
      ...
      <div className="space-y-3">
          ...
          <div>
              ...
              <div className="pl-2 text-xs space-y-1">
                ...
                <p className="pl-4 mt-1" style={{ color: '#4b5563' }}>└ 지급 계좌: {data.bank_name} {data.account_number} (예금주: {data.account_holder})</p>
              </div>
          </div>
          ...
          <div>
              ...
              <p
                className="pl-2 text-xs min-h-[30px] whitespace-pre-wrap rounded print:border-none"
                style={{ border: '1px solid #e5e7eb', backgroundColor: '#f9fafb', padding: '0.25rem' }}
              >
                {data.memo || "특이사항 없음."}
            ...
            <div className="text-left relative">
                ...
                <div className="relative">
                    ...
                    <img
                        src="/stamp.png"
                        alt="회사직인"
                        className="absolute -top-3 left-16 w-14 h-14 object-contain opacity-90 pointer-events-none"
                ...
                <div className="relative">
                    ...
                    {signatureUrl && (
                        <img
                            src={signatureUrl}
                            alt="서명"
                            className="absolute -top-4 left-10 w-16 h-10 object-contain"
                            style={{ mixBlendMode: 'multiply' }}
                        />
                    )}
                </div>
